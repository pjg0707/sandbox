...
# Sample dictionary
original_dict = {"Freq": [0.2, 2, 3, 4, 5, 100], "Data": [11.2, 21, 32.5, 45, 60, 61]}
...
interpolator = interp1d(df["Freq"], df["Data"], kind="linear", fill_value="extrapolate")
resampled_data = interpolator(original_dict["Freq"])

# Perform element-wise operation of the "Data" columns
new_data = [x - y for x, y in zip(original_dict["Data"], resampled_data, strict=False)]
